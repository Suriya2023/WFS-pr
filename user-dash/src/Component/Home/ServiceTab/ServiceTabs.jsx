    ...
    const services = [
        ...
        },
        {
            ...
            content: {
                ...
                desc: "Whether you’re building your own online store on Shopify, launching a personal website, or creating a dropshipping hub, we empower your business to expand globally with ease.",
        ...
        <section className="py-24 bg-black px-6 sm:px-10 lg:px-20 text-white relative overflow-hidden">
            ...
            <div className="text-center mb-12">
                ...
                <p className="text-gray-300 max-w-3xl mx-auto">
                    We’re dedicated to delivering reliable, high-quality service that drives your success. Whether it's 50 grams or 5 tons, from your warehouse to your customer's doorstep—entrust all your shipping needs to us. You bring the vision—we’ll help make it happen.
                </p>
            </div>
